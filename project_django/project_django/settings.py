...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-(38+w^amz_gx1%ia0cunppe+&mjkwch1h%$wc5tw4-75@-x^yw')
...
ERROR_LOG_FILE = os.environ.get('ERROR_LOG_FILE', str(LOG_DIR / 'error.log'))
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'django_basic_project',
    }
}
